...
public class Secretaria_RJ implements Secretaria {
	...
	public void verificarPedido() {
		System.out.println("A Secretaria inicia a Verificação do pedido para usar espaço público no Rio de Janeiro "
				          + "e para oficializar o compeonato. \n");
	}

	public void autorizar() {
		System.out.println("A Secretaria do Estado do Rio de Janeiro resolve, no uso de suas atribuições,"
